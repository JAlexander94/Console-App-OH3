...
let avgchange = sumchange/profchange.length;
avgchange = avgchange.toFixed(2);
let maxprof = Math.max.apply(Math, profchange);
let minprof = Math.min.apply(Math, profchange);
let maxindex = profchange.indexOf(maxprof);
let maxdate = datearray[maxindex+1];
